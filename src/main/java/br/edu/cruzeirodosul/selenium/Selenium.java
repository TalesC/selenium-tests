...
public class Selenium {
    ...
    public WebElement pegarItemPelaTagENome(String tagName, String nome) {
        return finder.pegarItensPelaTagENome(tagName, nome).get(0);
    }
    
    public WebElement pegarItemPelaTagEPlaceholder(String tagName, String placeholder) {
    	return finder.pegarItensPelaTagEPlaceholder(tagName, placeholder).get(0);
    }
